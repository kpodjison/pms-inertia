export default function EnquirySection() {
  return (
      <div id="enquiry_section">
          <div
              className="w-[90%] mx-auto h-[95vh] grid grid-cols-1 sm:grid-cols-2 py-10 sm:py-0 sm:items-center text-white"
          ...
          >
              <div>
                  ...
                  <p className="px-5">
                      Experience comfort and peace of mind in every step of your
                      home journey. Let us help you find the perfect place to
                      call home.
                  </p>
              </div>
              <div className="mx-5" id="contact-form">
                  <h5 className="px-8 text-black sm:text-xl font-bold">
                      Make an enquiry
                  </h5>
